...
function volume(command)
    awful.util.spawn("amixer sset Master,0 " .. command)
end
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "main", "mail", "browse", "chat", "other" }, s, awful.layout.layouts[1])
end
-- }}}
...
myawesomemenu = {
   ...
   { "alternate WM", function() awesome.exec(alternateWM) end},
   { "quit", awesome.quit },
}
...
systray = wibox.widget.systray("primary")
